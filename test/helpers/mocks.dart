...
class CartItemFixtures {
  static CartItem get sampleCartItem => CartItem(
  ...
  static List<CartItem> get sampleCartItems => [
        CartItem(
          product: ProductFixtures.sampleProducts[0],
          quantity: 2,
        ),
        CartItem(
          product: ProductFixtures.sampleProducts[1],
          quantity: 1,
        ),
      ];

  static CartItem get cartItemWithQuantity3 => CartItem(
        product: ProductFixtures.sampleProduct,
        quantity: 3,
      );
}
